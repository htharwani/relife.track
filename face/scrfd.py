    ...
    def _load_model(self):
        ...
        try:
            ...
            try:
                ...
                logger.info("SCRFD network group and InferVStreams activated permanently.")
            except Exception as e:
                logger.warning(f"Failed to activate SCRFD network group permanently: {e}. Falling back to dynamic activation.")
